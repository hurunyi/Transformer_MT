...
import torch
from data.tokenizer import tokenize_line
...
class Dictionary:
	...
	def add_from_file(self, f):
		...
		for line in tqdm(lines[indices_start_line:]):
			try:
	...
	def encode_line(self, line, line_tokenizer=tokenize_line, add_if_not_exist=True, consumer=None, append_eos=True,
					reverse_order=False) -> torch.IntTensor:
